...
import { BUSINESS, LEGAL_LINKS } from "@/lib/constants";
      ...
      <div className="mx-auto max-w-6xl px-6 py-14 lg:px-8">
        <div className="grid gap-10 md:grid-cols-4">
          <div className="md:col-span-2">
            <p className="font-display text-xl font-semibold">Espaço Cruzeiro</p>
            <p className="mt-3 max-w-sm text-sm text-muted-foreground">
              Buffet em Osasco para os momentos que você quer guardar pra sempre:
            ...
            <div className="mt-6 space-y-2 text-sm text-muted-foreground">
              ...
              <p className="flex items-center gap-2">
                ...
                <a href={`mailto:${BUSINESS.contact.email}`} className="hover:text-foreground">
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
              <li>
                <Link href="/eventos/casamentos" className="hover:text-foreground">
                  Casamentos
                </Link>
              </li>
              <li>
                <Link href="/eventos/aniversarios" className="hover:text-foreground">
                  Aniversários
                </Link>
              </li>
              <li>
                <Link href="/eventos/cha-de-bebe" className="hover:text-foreground">
                  Chá de bebê
                </Link>
              </li>
              <li>
                <Link href="/eventos/revelacao" className="hover:text-foreground">
                  Revelação
                </Link>
              </li>
              <li>
                <Link href="/eventos/corporativos" className="hover:text-foreground">
                  Corporativos
                </Link>
              </li>
              <li>
                <Link href="/eventos/confraternizacoes" className="hover:text-foreground">
                  Confraternizações
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="mt-5 flex items-center gap-3">
              ...
              <a
                href={waLink(waNumber, "Olá! Gostaria de saber mais sobre o Espaço Cruzeiro.")}
                target="_blank"
                rel="noopener noreferrer"
